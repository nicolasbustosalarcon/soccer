...
@section ('content')
	...
	<form class="form-group" method="POST" action="/club/{{$clubes->idClub}}" enctype="multipart/form-data">	
		...
		<div class="form-group">
			...
			<input type="text" name="nombreClub" class="form-control " value="{{$clubes->nombreClub}}">
			<label for="">Imagen</label>
			<input type="file" name="imagenClub" class="form-control">
			<label for="">Fundación</label>
			<input type="date" name="fundacionClub" class="form-control" value="{{$clubes->fundacionClub}}">
			<label for="">Sede</label>
			<input type="text" name="sedeClub" class="form-control" value="{{$clubes->sedeClub}}">

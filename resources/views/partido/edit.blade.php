...
@section ('titulo', 'Partido Edit - ' .' ' .$partidos->idPartido)

@section ('content')

	<form class="form-group" method="POST" action="/partido/{{$partidos->idPartido}}" enctype="multipart/form-data">	
		@method('PUT')
		@csrf
		<div class="form-group">
			...
			<input type="text" name="golesLocalPartido" class="form-control" value="{{$partidos->golesLocalPartido}}">

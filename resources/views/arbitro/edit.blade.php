...
<form class="form-group" method="POST" action="/arbitro/{{$arbitros->idArbitro}}" enctype="multipart/form-data">
	...
	<input type="file" name="imagenArbitro" class="form-control"><img src="images/arbitro/{{ $arbitros['imagenArbitro']}}" class="img-responsive" style="width:45px !important; height:45px !important"></div>-->
	<div class="form-group text-light">
	...
	<label class="text-light">Grado</label>
	...
	<label class="text-light">País</label>
    ...
    <label class="text-light">Asociación</label>
